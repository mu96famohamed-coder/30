...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.poain30.ae/${lang}/attestation/mofa/`,
      languages: {
        ...Object.fromEntries(
        LANGS.map((l) => [HREFLANG_MAP[l], `https://www.poain30.ae/${l}/attestation/mofa/`])
      ),
        'x-default': `https://www.poain30.ae/en/attestation/mofa/`,
      } } }
}
