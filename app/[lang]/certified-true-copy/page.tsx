...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.poain30.ae/${lang}/certified-true-copy/`,
      languages: {
        ...Object.fromEntries(
        LANGS.map((l) => [HREFLANG_MAP[l], `https://www.poain30.ae/${l}/certified-true-copy/`])
      ),
        'x-default': `https://www.poain30.ae/en/certified-true-copy/`,
      } } }
}
  ...
  return (
    <>
      <ServicePage
        ...
        breadcrumb={[
          { label: lang === 'ar' ? 'نسخة طبق الأصل' : 'Certified True Copy', href: '/certified-true-copy' }
        ]}
        relatedServices={[
