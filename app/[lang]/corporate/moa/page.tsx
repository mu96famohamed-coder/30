...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.poain30.ae/${lang}/corporate/moa/`,
      languages: {
        ...Object.fromEntries(
        LANGS.map((l) => [HREFLANG_MAP[l], `https://www.poain30.ae/${l}/corporate/moa/`])
      ),
        'x-default': `https://www.poain30.ae/en/corporate/moa/`,
      } } }
}
    ...
    <>
      <ServicePage
        ...
        breadcrumb={[
          ...
          { label: lang === 'ar' ? 'عقد تأسيس' : 'MOA Drafting', href: '/corporate/moa' }
        ]}
        relatedServices={[
