...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.poain30.ae/${lang}/corporate/shareholder-agreement/`,
      languages: {
        ...Object.fromEntries(
        LANGS.map((l) => [HREFLANG_MAP[l], `https://www.poain30.ae/${l}/corporate/shareholder-agreement/`])
      ),
        'x-default': `https://www.poain30.ae/en/corporate/shareholder-agreement/`,
      } } }
}
...
export default async function Page({ params }: Props) {
  ...
  return (
    <>
      <ServicePage
        path={'/corporate/shareholder-agreement'}
        lang={lang}
        title={seo?.h1}
        ...
        breadcrumb={[
          ...
          { label: lang === 'ar' ? 'اتفاقية شركاء' : 'Shareholder Agreement', href: '/corporate/shareholder-agreement' }
        ]}
        relatedServices={[
