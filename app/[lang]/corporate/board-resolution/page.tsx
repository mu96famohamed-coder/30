...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.poain30.ae/${lang}/corporate/board-resolution/`,
      languages: {
        ...Object.fromEntries(
        LANGS.map((l) => [HREFLANG_MAP[l], `https://www.poain30.ae/${l}/corporate/board-resolution/`])
      ),
        'x-default': `https://www.poain30.ae/en/corporate/board-resolution/`,
      } } }
}
...
export default async function Page({ params }: Props) {
  ...
  return (
    <>
      <ServicePage
        path={'/corporate/board-resolution'}
        lang={lang}
        title={seo?.h1}
        ...
        breadcrumb={[
          ...
          { label: lang === 'ar' ? 'قرار مجلس إدارة' : 'Board Resolution', href: '/corporate/board-resolution' }
        ]}
        relatedServices={[
